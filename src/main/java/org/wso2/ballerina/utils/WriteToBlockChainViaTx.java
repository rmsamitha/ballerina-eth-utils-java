...
public class WriteToBlockChainViaTx {
    public static String writeBlockchainRecordViaTx(String key, String value, String blockChainAPIURL, String account, String password) {
        String s = null;
